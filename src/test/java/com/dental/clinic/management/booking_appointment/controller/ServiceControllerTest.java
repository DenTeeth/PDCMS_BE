...
class ServiceControllerTest {
    ...
    @Test
    @DisplayName("PUT /api/v1/services/{serviceId} - Update service")
    ...
    void updateService_ShouldReturnUpdatedService() throws Exception {
        ...
        when(serviceService.updateService(eq(1), any(UpdateServiceRequest.class))).thenReturn(updatedService);

        // When & Then
        mockMvc.perform(put("/api/v1/services/{serviceId}", 1)
                .with(csrf())
                .contentType(MediaType.APPLICATION_JSON)
        ...
        verify(serviceService, times(1)).updateService(eq(1), any(UpdateServiceRequest.class));
    }

    @Test
    @DisplayName("DELETE /api/v1/services/{serviceId} - Soft delete service")
    ...
    void deleteService_ShouldReturnNoContent() throws Exception {
        ...
        verify(serviceService, times(1)).deleteService(1);
    }
