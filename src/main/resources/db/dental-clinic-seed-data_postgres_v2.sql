...
-- MODULE 11: WAREHOUSE (Warehouse Management)
INSERT INTO permissions (permission_id, permission_name, module, description, display_order, parent_permission_id, is_active, created_at)
VALUES
('VIEW_SUPPLIER', 'VIEW_SUPPLIER', 'WAREHOUSE', 'Xem danh sách nhà cung cấp', 240, NULL, TRUE, NOW()),
('CREATE_SUPPLIER', 'CREATE_SUPPLIER', 'WAREHOUSE', 'Tạo nhà cung cấp mới', 241, NULL, TRUE, NOW()),
('UPDATE_SUPPLIER', 'UPDATE_SUPPLIER', 'WAREHOUSE', 'Cập nhật nhà cung cấp', 242, NULL, TRUE, NOW()),
('DELETE_SUPPLIER', 'DELETE_SUPPLIER', 'WAREHOUSE', 'Xóa nhà cung cấp', 243, NULL, TRUE, NOW()),
('VIEW_CATEGORY', 'VIEW_CATEGORY', 'WAREHOUSE', 'Xem danh sách danh mục hàng hóa', 244, NULL, TRUE, NOW()),
('CREATE_CATEGORY', 'CREATE_CATEGORY', 'WAREHOUSE', 'Tạo danh mục hàng hóa mới', 245, NULL, TRUE, NOW()),
('UPDATE_CATEGORY', 'UPDATE_CATEGORY', 'WAREHOUSE', 'Cập nhật danh mục hàng hóa', 246, NULL, TRUE, NOW()),
('DELETE_CATEGORY', 'DELETE_CATEGORY', 'WAREHOUSE', 'Xóa danh mục hàng hóa', 247, NULL, TRUE, NOW()),
('VIEW_INVENTORY', 'VIEW_INVENTORY', 'WAREHOUSE', 'Xem danh sách tồn kho', 248, NULL, TRUE, NOW()),
('CREATE_INVENTORY', 'CREATE_INVENTORY', 'WAREHOUSE', 'Tạo hàng hóa tồn kho mới', 249, NULL, TRUE, NOW()),
('UPDATE_INVENTORY', 'UPDATE_INVENTORY', 'WAREHOUSE', 'Cập nhật tồn kho', 250, NULL, TRUE, NOW()),
('DELETE_INVENTORY', 'DELETE_INVENTORY', 'WAREHOUSE', 'Xóa tồn kho', 251, NULL, TRUE, NOW()),
('VIEW_STORAGE_TRANSACTION', 'VIEW_STORAGE_TRANSACTION', 'WAREHOUSE', 'Xem lịch sử nhập/xuất kho', 252, NULL, TRUE, NOW()),
('CREATE_STORAGE_TRANSACTION', 'CREATE_STORAGE_TRANSACTION', 'WAREHOUSE', 'Tạo phiếu nhập/xuất kho', 253, NULL, TRUE, NOW()),
('UPDATE_STORAGE_TRANSACTION', 'UPDATE_STORAGE_TRANSACTION', 'WAREHOUSE', 'Cập nhật phiếu nhập/xuất kho', 254, NULL, TRUE, NOW()),
('DELETE_STORAGE_TRANSACTION', 'DELETE_STORAGE_TRANSACTION', 'WAREHOUSE', 'Xóa phiếu nhập/xuất kho', 255, NULL, TRUE, NOW())
ON CONFLICT (permission_id) DO NOTHING;
...
-- Inventory Manager (WAREHOUSE + LEAVE)
INSERT INTO role_permissions (role_id, permission_id)
VALUES
-- WAREHOUSE permissions
('ROLE_INVENTORY_MANAGER', 'VIEW_SUPPLIER'), ('ROLE_INVENTORY_MANAGER', 'CREATE_SUPPLIER'),
('ROLE_INVENTORY_MANAGER', 'UPDATE_SUPPLIER'), ('ROLE_INVENTORY_MANAGER', 'DELETE_SUPPLIER'),
('ROLE_INVENTORY_MANAGER', 'VIEW_CATEGORY'), ('ROLE_INVENTORY_MANAGER', 'CREATE_CATEGORY'),
('ROLE_INVENTORY_MANAGER', 'UPDATE_CATEGORY'), ('ROLE_INVENTORY_MANAGER', 'DELETE_CATEGORY'),
('ROLE_INVENTORY_MANAGER', 'VIEW_INVENTORY'), ('ROLE_INVENTORY_MANAGER', 'CREATE_INVENTORY'),
('ROLE_INVENTORY_MANAGER', 'UPDATE_INVENTORY'), ('ROLE_INVENTORY_MANAGER', 'DELETE_INVENTORY'),
('ROLE_INVENTORY_MANAGER', 'VIEW_STORAGE_TRANSACTION'), ('ROLE_INVENTORY_MANAGER', 'CREATE_STORAGE_TRANSACTION'),
('ROLE_INVENTORY_MANAGER', 'UPDATE_STORAGE_TRANSACTION'), ('ROLE_INVENTORY_MANAGER', 'DELETE_STORAGE_TRANSACTION'),
-- LEAVE permissions
