package com.dental.clinic.management.employee_shifts.service;
...
import com.dental.clinic.management.employee_shifts.mapper.EmployeeShiftMapper;
import com.dental.clinic.management.employee_shifts.repository.EmployeeShiftRepository;
import com.dental.clinic.management.employee_shifts.utils.EmployeeShiftValidator;
...
public class EmployeeShiftService {
    ...
    public List<EmployeeShiftResponseDto> getShiftsForCalendarView(
        ...
        if (!hasViewAll && !hasViewOwn) {
            throw new AccessDeniedException("You don't have permission to view shifts");
        }
        ...
        if (hasViewAll) {
            ...
            if (employeeId != null && !employeeId.equals(currentEmployee.getEmployeeId())) {
                ...
                throw new AccessDeniedException(
                        "Bạn không có quyền xem lịch làm việc của nhân viên khác");
            }
    ...
    public EmployeeShiftResponseDto createManualShift(CreateShiftRequestDto requestDto) {
        ...
        WorkShift workShift = workShiftRepository.findById(requestDto.getWorkShiftId())
                .orElseThrow(() -> new WorkShiftNotFoundException(
                        "Nhân viên hoặc Mẫu ca làm việc không tồn tại."));
