...
public class ClinicalRecordService {
    ...
    private ClinicalRecordResponse buildClinicalRecordResponse(ClinicalRecord record, Appointment appointment) {
        ...
        PatientDTO patientDTO = PatientDTO.builder()
                ...
                .dateOfBirth(patient.getDateOfBirth() != null ? patient.getDateOfBirth().format(DATE_FORMATTER) : null)
        ...
        var procedures = record.getProcedures().stream()
                .map(proc -> ProcedureDTO.builder()
                        ...
                        .serviceCode(proc.getService() != null ? proc.getService().getServiceCode() : null)
                        .serviceName(proc.getService() != null ? proc.getService().getServiceName() : null)
                        .patientPlanItemId(
                                proc.getPatientPlanItem() != null ? proc.getPatientPlanItem().getItemId().intValue()
                                        : null)
                ...
                .map(presc -> {
                    var items = presc.getItems().stream()
                            .map(item -> PrescriptionItemDTO.builder()
                                    ...
                                    .itemCode(item.getItemMaster() != null ? item.getItemMaster().getItemCode() : null)
