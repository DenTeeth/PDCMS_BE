...
public class AdminLeaveBalanceController {
        ...
        private static final Logger log = LoggerFactory.getLogger(AdminLeaveBalanceController.class);

        private final AdminLeaveBalanceService balanceService;

        public AdminLeaveBalanceController(AdminLeaveBalanceService balanceService) {
