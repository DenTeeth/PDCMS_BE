...
public class PartTimeSlotService {
        ...
        private void validateDaysOfWeek(String dayOfWeek) {
                ...
                for (String day : days) {
                        ...
                        try {
                                ...
                                throw new IllegalArgumentException("Ngày trong tuần không hợp lệ: " + trimmedDay +
                                ...
                                .map(reg -> {
                                        ...
                                        return PartTimeSlotDetailResponse.RegisteredEmployeeInfo.builder()
                                                        ...
                                                        .employeeCode(employee != null ? employee.getEmployeeCode()
                                                                        : "Unknown")
                                                        .employeeName(employee != null ? employee.getFullName()
                                                                        : "Unknown")
        ...
        public void deleteSlot(Long slotId) {
                ...
                if (!slot.getIsActive()) {
                        ...
                        throw new IllegalStateException("Suất đã bị vô hiệu hóa");
                }
        ...
        public com.dental.clinic.management.working_schedule.dto.response.SlotStatisticsResponse getSlotStatistics() {
                ...
                List<com.dental.clinic.management.working_schedule.dto.response.SlotStatisticsResponse.ShiftStatistics> shiftStats = slotsByShift
                                .entrySet().stream()
                                .map(entry -> {
                                        ...
                                        String shiftName = slots.isEmpty() ? "Unknown"
                                                        : (slots.get(0).getWorkShift() != null
                                                                        ? slots.get(0).getWorkShift().getShiftName()
                                                                        : "Shift " + shiftId);

                                        long quota = slots.stream().mapToLong(PartTimeSlot::getQuota).sum();
                                        long approved = slots.stream()
                                                        .mapToLong(slot -> partTimeSlotRepository
                                                                        .countApprovedRegistrations(slot.getSlotId()))
                                                        .sum();
                                        long available = quota - approved;
                                        double staffing = quota > 0 ? (approved * 100.0 / quota) : 0.0;

                                        return com.dental.clinic.management.working_schedule.dto.response.SlotStatisticsResponse.ShiftStatistics
                                                        .builder()
                                                        .shiftName(shiftName)
                ...
                List<com.dental.clinic.management.working_schedule.dto.response.SlotStatisticsResponse.DayStatistics> dayStats = slotsByDay
                                .entrySet().stream()
                                .map(entry -> {
                                        ...
                                        return com.dental.clinic.management.working_schedule.dto.response.SlotStatisticsResponse.DayStatistics
                                                        .builder()
                                                        .dayOfWeek(day)
                                                        .totalSlots(slots.size())
                                                        .totalQuota(quota)
