 ...
 * 
 * PROBLEM:
 * - Part-Time Flex employees register (claim) slots with effective_to = 3 months later
...
public class CleanupExpiredFlexRegistrationsJob {
    ...
    public void cleanupExpiredRegistrations() {
        ...
        log.info("Looking for expired Part-Time Flex registrations in 'part_time_registrations' (effective_to < {})", today);
