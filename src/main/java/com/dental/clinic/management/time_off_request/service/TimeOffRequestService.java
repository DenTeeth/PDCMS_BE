package com.dental.clinic.management.time_off_request.service;
...
import com.dental.clinic.management.time_off_request.mapper.TimeOffRequestMapper;
import com.dental.clinic.management.time_off_request.repository.TimeOffRequestRepository;
import com.dental.clinic.management.time_off_request.repository.TimeOffTypeRepository;
...
public class TimeOffRequestService {
    ...
    public TimeOffRequestResponse createRequest(CreateTimeOffRequest request) {
        ...
        typeRepository.findByTypeIdAndIsActive(request.getTimeOffTypeId(), true)
