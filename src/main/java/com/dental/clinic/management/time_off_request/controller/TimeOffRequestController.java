package com.dental.clinic.management.time_off_request.controller;

import com.dental.clinic.management.time_off_request.dto.request.CreateTimeOffRequest;
import com.dental.clinic.management.time_off_request.dto.request.UpdateTimeOffStatusRequest;
...
import com.dental.clinic.management.time_off_request.service.TimeOffRequestService;
...
public class TimeOffRequestController {
     ...
     * 
     * @param employeeId Filter by employee_id (optional, ignored for VIEW_TIMEOFF_OWN)
    ...
    public ResponseEntity<Page<TimeOffRequestResponse>> getAllRequests(
        ...
        log.info("REST request to get all time-off requests with filters: employeeId={}, status={}, startDate={}, endDate={}",
     ...
     * - status=CANCELLED: CANCEL_TIMEOFF_OWN (nếu là chủ sở hữu) hoặc CANCEL_TIMEOFF_PENDING (nếu là quản lý)
     *   (reason bắt buộc)
     * 
     * Business Logic:
     ...
     * 
     * @param requestId The ID of the time-off request
     * @param request UpdateTimeOffStatusRequest with new status and optional reason
