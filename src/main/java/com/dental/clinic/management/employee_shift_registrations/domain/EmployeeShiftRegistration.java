...
public class EmployeeShiftRegistration {
    ...
    private List<RegistrationDays> registrationDays;

    // Constructors
    public EmployeeShiftRegistration() {
    }

    public EmployeeShiftRegistration(String registrationId, Integer employeeId, String slotId, LocalDate effectiveFrom,
            LocalDate effectiveTo, Boolean isActive) {
