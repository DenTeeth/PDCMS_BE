...
public class ServiceConsumableController {
     ...
     * Returns list of consumable items required for a service with stock availability and cost info
     * 
     * Use Case:
    ...
    @Operation(
        summary = "Get service consumables (BOM)",
        description = "Get list of consumable items required for a service with current stock status and estimated cost. " +
