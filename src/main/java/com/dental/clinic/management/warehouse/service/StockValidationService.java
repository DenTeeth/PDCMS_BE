 ...
 * 
 * Implements:
 * - Rule #18: Cannot export from warehouse if current stock quantity is lower
 * than requested
 */
@Service
public class StockValidationService {
    ...
    public void validateStockAvailability(Long itemMasterId, Integer requestedQuantity, String itemName) {
        if (itemMasterId == null || requestedQuantity == null) {
            throw new IllegalArgumentException("Mã vật tư và số lượng yêu cầu không được để trống");
        }
